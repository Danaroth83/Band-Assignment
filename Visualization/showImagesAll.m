%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description: 
%           Visualize all the images applying the same stretching for visual comparison reasons.
% 
% Interface:
...
%
% Outputs:
%           MatrixPrint:        Matrix, with the same structure of MatrixImage, that contains the plotted images.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
