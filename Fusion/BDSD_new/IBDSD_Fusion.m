function MS_out = IBDSD_Fusion( Pan, MS_in, ratio, GNyq_PAN, GNyq_MS, B1, B2 )
%IBDSD_FUSION Improved local BDSD MMSE Fusion
...
for i1=1:L1f
    ...
    for i2=1:L2f
        ...
        Hd=cat(2,MS_in_Lblock,ones(Bsq,1),reshape(P_L(iA,iB),[Bsq,1]));
...
%         end
        ...
        H=cat(2,MS_inblock,ones(Bsq_FR,1),reshape(Pan(iA_FR,iB_FR),[Bsq_FR,1]));
