...
% 
% Interface:
%           I_Fus_MTF_GLP_HPM_PP = MTF_GLP_HPM_PP(I_PAN,I_MS,GNyq,ratio)
%
% Inputs:
%           I_PAN:          PAN image;
...
function I_Fus_MTF_GLP_HPM_PP = MTF_GLP_HPM_PP(I_PAN,I_MS,GNyq,ratio)
...
% for ii = 1 : nBands
% t(:,:,ii) = imresize(PAN_LP_LP(:,:,ii),[size(PAN_LP_D,1) size(PAN_LP_D,2)],'bilinear');
% end
% PAN_LP_LP=t;
% keyboard
