...
%           exploiting the Modulation Transfer Function - Generalized Laplacian Pyramid (MTF-GLP) with CBD algorithm. 
% 
% Interface:
%           I_MTF_GLP_CBD = MTF_GLP_CBD(I_MS,I_PAN,ratio,blockSize,threshold,GNyq)
%
% Inputs:
...
function I_MTF_GLP_CBD = MTF_GLP_CBD(I_MS,I_PAN,ratio,blockSize,threshold,GNyq)
